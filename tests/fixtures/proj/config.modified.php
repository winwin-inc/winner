...
use function winwin\support\secret;
    ...
    'application' => [
        'web' => [
            ...
            'session' => [
                ...
                'lifetime' => env('APP_SESSION_LIFETIME', strval(3600 * 24)),
            ],
            'context_url' => '',
            'error' => [
                'include_stacktrace' => 'true' === env('APP_DEBUG_MODE') ? IncludeStacktrace::ALWAYS : IncludeStacktrace::ON_TRACE_PARAM,
        ...
        'database' => [
            ...
            'table_prefix' => env('DB_TABLE_PREFIX', 'zhidou_'),
        ...
        'hologres' => [
            ...
            'name' => env('HOLO_NAME'),
            'user' => secret('holo.user'),
            'password' => secret('holo.pass'),
            'logging' => 'true' === env('DB_LOGGING'),
        ],
        'cache' => [
        ...
        'http_client' => [
            'default' => [
                ...
                'log_format' => env('HTTP_LOG_FORMAT', 'clf'),
            ],
        ],
        'job-processor' => [
